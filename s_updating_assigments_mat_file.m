...
for i = 3:size(filefolder_struct)
    ...
    path = [spectra_details_folder filesep filefolder_name '\tissue only\']; % location of the total spectrum mat file
    ...
    total_intensity = double(relevant_lists_sample_info(:,6)); % total intensities array
