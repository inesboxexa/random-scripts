dataPath = 'X:\Beatson\Intracolonic tumour study\Neg DESI Data\Xevo V3 Sprayer\Autumn 2020 (Round 2, Set 2)\To Convert\';
WatersConvert = '"C:\WatersConvert\watersconvert.exe"';
addpath(genpath('C:\WatersConvert\'));
